            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Mettre a jour un slide</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form method="POST" action="{{ route('carou.update', $editData->id) }}" enctype="multipart/form-data">
                                    @csrf
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                       <textarea name="body" cols="80" rows="6">{{ $editData->body }}</textarea>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <img id="showImage"
                                                            src="{{ !empty($editData->image) ? url('upload/carou_image/' . $editData->image) : url('upload/no_image.jpg') }}"
