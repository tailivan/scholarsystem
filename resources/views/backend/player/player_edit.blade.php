            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form method="POST" action="{{ route('player.update', $editData->id) }}" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="poste_id" id="select" required="" class="form-control">
                                                            ...
                                                            <option value="{{ $p->id }}" {{ $p->id == $editData->poste_id ? "selected" :"" }}>{{ $p->name}}</option>
                                                            @endforeach
                                          ...
                                          <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="taille" value="{{ $editData->taille }}" class="form-control"> 
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <img id="showImage"
                                                            src="{{ !empty($editData->image) ? url('upload/player_image/' . $editData->image) : url('upload/no_image.jpg') }}"
